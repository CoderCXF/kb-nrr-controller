...
import (
	...
	"nrr-controller/pkg/client/clientset/versioned/scheme"
...
// CloudV1Client is used to interact with features provided by the cloud.dancingcode.com group.
type CloudV1Client struct {
	restClient rest.Interface
}

func (c *CloudV1Client) NamespaceResourceReports(namespace string) NamespaceResourceReportInterface {
